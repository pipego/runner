...
var file_server_proto_server_proto_msgTypes = make([]protoimpl.MessageInfo, 41)
...
func file_server_proto_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_server_proto_server_proto_msgTypes[40].Exporter = func(v interface{}, i int) interface{} {
